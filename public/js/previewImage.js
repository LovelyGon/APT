! function(a) {
    ...
    function d(b, c, d, e, f) {
        ...
        a(g).attr('class','div_image');
        g.appendChild(f);
        var h = document.createElement("p"),
            i = document.createTextNode(c);
        return a(h).attr("data-upload-preview", e), a(h).attr('class',"delete"),a(h).append("<i class='fa fa-trash-o'>"),h.appendChild(i),h.style.cursor = "pointer","before" == d ? g.insertBefore(h, f) : g.appendChild(h), g
    }
